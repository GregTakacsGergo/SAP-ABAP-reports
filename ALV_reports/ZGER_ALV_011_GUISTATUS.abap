...
*&---------------------------------------------------------------------*
*& This report analyzes and displays customer data (KNA1 and KNVV tables) in ALV format.
*& Filtering is possible by country, customer number, name, postal code, and sales organization.
*& The report calculates the number of sales organizations for each customer and colors rows based on these values.
*& Additionally, it displays detailed sales organization data in a pop-up window upon double-click.
*&---------------------------------------------------------------------*
REPORT ZGER_ALV_011_HOME_S01E09.
